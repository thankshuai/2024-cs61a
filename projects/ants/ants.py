...
class HarvesterAnt(Ant):
    ...
    def action(self, gamestate):
        ...
        # BEGIN Problem 1
        "*** YOUR CODE HERE ***"
        gamestate.food += self.food_product
        # END Problem 1
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        move_distance = 0
        while move_distance < self.lower_bound:
            if current_place.entrance is None or current_place.is_hive:
                return None
            current_place = current_place.entrance
            move_distance += 1
        while current_place.bees == [] and move_distance < self.upper_bound:
...
class FireAnt(Ant):
    ...
    def reduce_health(self, amount):
        ...
        # BEGIN Problem 5
        "*** YOUR CODE HERE ***"
        currend_place = self.place
        Ant.reduce_health(self, amount)
        if self.place is None:
            amount = amount + self.damage  
        [Insect.reduce_health(bee, amount) for bee in list(currend_place.bees)]
        # END Problem 5
